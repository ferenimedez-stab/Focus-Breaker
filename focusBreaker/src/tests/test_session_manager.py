...
"""
        ...
        console.print("[dim]Testing session_manager.py functionality[/dim]\n")
        ...
        try:
            from core.session_manager import SessionManager
            console.print("  [green]✓[/green] Session manager module imports successful")
        except ImportError as e:
            console.print(f"  [red]✗[/red] Session manager module import failed: {e}")
        
        # Database Status
        try:
            from data.db import DBManager
            console.print("  [green]✓[/green] Database manager available")
        except ImportError:
            console.print("  [red]✗[/red] Database manager not available")
        
        # Models Status
        try:
            from data.models import WorkSession, Task, Settings
            console.print("  [green]✓[/green] Data models available")
        except ImportError as e:
            console.print(f"  [yellow]⚠[/yellow] Data models import failed: {e}")
        
        # Timer Status
        try:
            from core.timer import TimerState
            console.print("  [green]✓[/green] Timer module available")
        except ImportError:
            console.print("  [yellow]⚠[/yellow] Timer module not available")
        ...
        try:
            ...
            console.print("  [green]✓[/green] Session manager initialized successfully")
        except Exception as e:
            console.print(f"  [yellow]⚠[/yellow] Session manager initialization failed: {e}")
